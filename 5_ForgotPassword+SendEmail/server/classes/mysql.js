...
connectionConfig = {
    ...
    user: "test_react", // юзер, под которым заходишь на сервер. По-хорошему, для каждого приложения лучше делать отдельного юзера для секурности
    password: "0JPv630ffN", // Пароль
